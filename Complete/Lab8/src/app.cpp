...
void App::update() {
	...
	if (glfwGetKey(window, GLFW_KEY_3) == GLFW_PRESS) house.setShader(&shader3Dmodel2);
	if (glfwGetKey(window, GLFW_KEY_4) == GLFW_PRESS) house.setShader(&shader3Dmodel3);
	...
	if (glfwGetKey(window, GLFW_KEY_3) == GLFW_PRESS) brickWall.setShader(&shader3Dmodel);
	if (glfwGetKey(window, GLFW_KEY_4) == GLFW_PRESS) brickWall.setShader(&shader3Dmodel3);
